<template>
  <div class="wrapper">
    <h3> Welcome to Zenith!</h3>
    <br>
    <p>Discover a new dimension in messaging with Zenith, where simplicity meets sophistication.
      Whether you're connecting with friends, family, or colleagues,
      Zenith is designed to enhance your communication experience.</p>
    <br>
    <h3>Key Features:</h3>
